...
<div class="space-y-8">
        ...
        title="Riwayat Penawaran Panen" 
        subtitle="Lihat daftar penawaran hasil panen yang telah disetujui atau ditolak."
        icon="archive-box"
        color="emerald"
    />
    ...
    <x-petani-table-filter placeholder="Cari data riwayat penawaran panen..." />
