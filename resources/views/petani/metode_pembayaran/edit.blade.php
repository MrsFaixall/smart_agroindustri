    ...
    <form action="{{ route('metode-pembayaran.update', $method->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl p-8 shadow-sm border border-slate-200 border-t-4 border-t-[#001842] space-y-6">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div class="space-y-2 md:col-span-2">
                ...
                <input type="text" name="no_rekening" id="no_rekening" inputmode="numeric" maxlength="10" value="{{ old('no_rekening', $method->no_rekening) }}" placeholder="Masukkan nomor rekening (Contoh: 1234567890)" 
            ...
            <!-- QRIS Upload -->
            <div class="space-y-2 md:col-span-2">
                <label for="qr_image" class="text-sm font-bold text-slate-700">Upload QR Code Baru (Khusus QRIS / Digital)</label>
