...
<div class="max-w-3xl space-y-6">
    <div>
        <h1 class="text-2xl font-bold">Tambah Stok</h1>
        <p class="text-slate-500">Tambahkan catatan stok kentang.</p>
    </div>
    ...
    <form action="{{ route('stok.store') }}" method="POST" class="space-y-6 rounded-3xl bg-white p-8 shadow-sm border border-slate-200">
        ...
        <div class="space-y-5">
            ...
            <label class="space-y-2">
                ...
                <input type="number" step="0.01" name="jumlah_stok" value="{{ old('jumlah_stok') }}" class="w-full rounded-xl border px-4 py-3" required>
            </label>
