...
<div class="space-y-8">
    <!-- Header VIP -->
        ...
        title="Tagihan Penjualan Panen" 
        subtitle="Lihat status pembayaran penjualan panen dari Koperasi."
        icon="credit-card"
        color="indigo"
    />
    ...
    <div>
        <div class="flex items-center gap-3 mb-4 px-2">
            ...
            <div>
                <h2 class="flex items-center gap-2 text-lg font-bold text-slate-800">Daftar Pembelian Panen (Tagihan dari Petani)</h2>
    ...
    <x-petani-table-filter placeholder="Cari data tagihan penjualan panen..." />
