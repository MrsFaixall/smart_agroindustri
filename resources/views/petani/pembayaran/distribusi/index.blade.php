...
<div class="space-y-8">
    <!-- Header VIP -->
        ...
        title="Tagihan Distribusi Benih" 
        subtitle="Bayar tagihan distribusi benih yang diterima dari Koperasi."
        icon="credit-card"
        color="indigo"
    />
    ...
    <div>
        <div class="flex items-center gap-3 mb-4 px-2">
            ...
            <div>
                <h2 class="flex items-center gap-2 text-lg font-bold text-slate-800">Daftar Pengadaan Benih (Tagihan dari Koperasi)</h2>
    ...
    <x-petani-table-filter placeholder="Cari data tagihan distribusi benih..." />
                    ...
                    <th class="px-6 py-4">Koperasi & Petani</th>
                ...
                <tr class="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td class="px-6 py-4">
                        <div class="font-bold text-slate-800">{{ $t->koperasi->name ?? '-' }} <span class="text-slate-400 font-normal">/</span> {{ $t->petani->name ?? '-' }}</div>
                    ...
                    <td class="px-6 py-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            @if($t->status !== 'lunas')
                                <form action="{{ route('distribusi-benih.bayar', $t->id) }}" method="POST" class="inline">
                                    @csrf
                ...
                @empty
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center text-slate-400 font-medium">Belum ada data tagihan distribusi benih.</td>
                </tr>
                @endforelse
