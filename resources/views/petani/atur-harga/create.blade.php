...
<div class="max-w-3xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Tambah Harga Kentang</h1>
            <p class="text-xs text-slate-400">Tentukan harga pasaran acuan per jenis kentang.</p>
        </div>
    </div>
    ...
    <form action="{{ route('atur-harga.store') }}" method="POST" class="space-y-6 rounded-3xl bg-white p-8 shadow-xl shadow-slate-100/60 border border-slate-100 relative overflow-hidden">
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
            ...
            <button type="submit" class="rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-amber-500/30 transition-all">Simpan Harga</button>
        </div>
    </form>
</div>
@endsection
