...
<div class="mx-auto max-w-7xl space-y-8">
    <x-petani-page-header 
        title="Atur Harga Petani" 
        subtitle="Monitor harga acuan pasaran kentang dari Koperasi, dan atur harga kentang Anda sendiri."
        icon="currency-dollar"
        color="amber"
        bgImage="bg-pasar.jpg"
        actionUrl="{{ route('atur-harga.create') }}"
        actionText="Input Harga Baru"
        actionIcon="plus"
    />
    ...
    <div class="grid gap-6 xl:grid-cols-5">
        <div class="space-y-6 xl:col-span-3">
            <x-petani-table-filter placeholder="Cari komoditas kentang..." />
            ...
            <div class="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xl shadow-slate-100/60 mb-6">
                <div class="flex items-center justify-between border-b border-slate-100 px-6 py-5 bg-slate-50/50">
                    <div>
                        <h2 class="flex items-center gap-2 font-bold text-lg text-slate-800">Daftar Harga Pasar (Koperasi)</h2>
            ...
            <div class="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xl shadow-slate-100/60">
                <div class="flex items-center justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        <h2 class="flex items-center gap-2 font-bold text-lg text-slate-800">Harga Jual Anda</h2>
