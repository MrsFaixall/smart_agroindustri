...
<div class="max-w-3xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Catat Hasil Panen</h1>
            <p class="text-xs text-slate-400">Isi data hasil panen komoditas kentang terbaru.</p>
        </div>
    </div>
    ...
    <form action="{{ route('panen.store') }}" method="POST" class="space-y-6 rounded-3xl bg-white p-8 shadow-xl shadow-slate-100/60 border border-slate-100 relative overflow-hidden">
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
            ...
            <button type="submit" class="rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/30 transition-all">Simpan Hasil Panen</button>
        </div>
    </form>
</div>
@endsection
