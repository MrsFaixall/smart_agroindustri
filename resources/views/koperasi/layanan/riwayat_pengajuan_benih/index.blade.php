...
<div class="space-y-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gradient-to-r from-blue-900 via-indigo-950 to-slate-900 p-6 md:p-8 rounded-3xl text-white shadow-xl shadow-slate-200/50 relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-1">
            ...
            <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight">Riwayat Pengajuan Benih</h1>
            <p class="text-blue-100/80 text-sm max-w-xl">Rekap seluruh pengajuan benih yang masuk dari Petani beserta status persetujuan.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div class="bg-gradient-to-br from-rose-50/80 via-white to-red-50/40 border border-rose-100 p-5 rounded-3xl shadow-sm">
            ...
            <h3 class="text-2xl font-extrabold text-rose-700">{{ $pengajuans->where('status', 'ditolak')->count() }}</h3>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-slate-400">
                        <p class="text-sm font-medium">Belum ada riwayat pengajuan benih masuk.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
