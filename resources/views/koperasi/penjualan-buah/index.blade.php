...
<div class="space-y-6 max-w-6xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Penjualan Hasil Panen (Koperasi -> Pasar/PT Champ)</h1>
            <p class="text-sm text-slate-500">Penjualan stok komoditas kentang Koperasi ke Mitra atau Konsumen.</p>
        </div>
        <a href="{{ route('penjualan-buah.create') }}" class="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-5 py-2.5 rounded-2xl font-bold transition-all shadow-lg shadow-purple-600/30">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        ...
                        <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Pembeli (Mitra / Konsumen)</th>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="py-4 px-4 text-sm font-medium text-slate-600">{{ $t->pembeli->name ?? '-' }}</td>
