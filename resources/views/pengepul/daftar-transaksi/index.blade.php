    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">
                Daftar Transaksi & Riwayat Pembayaran
            </h1>
            <p class="mt-1 text-sm text-slate-500">
                Lihat seluruh daftar riwayat transaksi, cetak invoice resmi, dan struk pembayaran.
            </p>
        </div>
    </div>
        ...
        <form action="{{ route('daftar-transaksi.index') }}" method="GET" class="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 w-full">
            ...
            <div class="flex items-center gap-2">
                ...
                @if(request('search') || request('period') || request('start_date') || request('end_date'))
                    <a href="{{ route('daftar-transaksi.index') }}" class="inline-flex items-center px-3 py-2 border border-slate-300 text-xs font-semibold rounded-lg text-slate-600 bg-white hover:bg-slate-50 transition-colors">
                        Reset
                    </a>
                @endif
            </div>
            ...
            <table class="w-full text-left text-sm whitespace-nowrap">
                <thead class="bg-white border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-slate-500">No. Invoice (INV)</th>
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-slate-500">Pelanggan / Petani</th>
                        ...
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-slate-500 text-center">Aksi / Dokumen</th>
                    </tr>
                </thead>
