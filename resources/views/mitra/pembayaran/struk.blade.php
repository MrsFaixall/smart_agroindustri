    ...
    <div style="max-width: 80mm; width: 100%;">
        ...
        <div class="struk-card">
            <div class="text-center">
                ...
                <p style="font-size: 10px;">Nota Pembayaran Komoditas Mitra</p>
            </div>
            ...
            <div class="row">
                <span>No. INV:</span>
                <span class="bold">INV-{{ str_pad($payment->id, 5, '0', STR_PAD_LEFT) }}</span>
            </div>
            <div class="row">
                <span>No. TRX:</span>
                <span class="bold">INV-{{ str_pad($payment->penjualan_buah_id, 5, '0', STR_PAD_LEFT) }}</span>
            </div>
            <div class="row">
                <span>Tanggal:</span>
            ...
            <div class="row">
                <span>Pembeli:</span>
                <span class="bold">{{ substr($payment->penjualanBuah->pembeli->name ?? 'Mitra', 0, 15) }}</span>
            </div>
