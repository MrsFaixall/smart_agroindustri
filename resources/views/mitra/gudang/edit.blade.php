...
<div class="max-w-4xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Edit Gudang Mitra</h1>
            <p class="text-xs text-slate-400">Perbarui informasi lokasi dan koordinat gudang Mitra PT. Champ.</p>
        </div>
    </div>
    ...
    <form action="{{ route('mitra-gudang.update', $gudang) }}" method="POST" class="space-y-6 rounded-3xl bg-white p-8 shadow-xl shadow-slate-100/60 border border-slate-100 relative overflow-hidden">
