...
<div class="space-y-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gradient-to-r from-emerald-950 via-teal-900 to-slate-900 p-6 md:p-8 rounded-3xl text-white shadow-xl shadow-slate-200/50 relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-1">
            ...
            <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight">Riwayat Penjualan Kentang</h1>
            <p class="text-emerald-100/80 text-sm max-w-xl">Rekap seluruh riwayat transaksi penjualan kentang Mitra ke Konsumen.</p>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-slate-400">
                        <p class="text-sm font-medium">Belum ada riwayat penjualan kentang.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
